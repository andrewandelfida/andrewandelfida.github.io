...
All copy for all three languages is in one file: **[`src/content/strings.ts`](src/content/strings.ts)**.

Find the key, edit the Ukrainian, Romanian and English versions, then:
...
src/
  content/          ← EDIT THESE
    strings.ts        all copy, all three languages
